...
class FM_demod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.reference_level = reference_level = -25
        ...
        self._reference_level_range = Range(-50, 23, 1, -25, 200)
        ...
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.htra_source_0 = htra_source.htra_source("USB",0,"'192.168.1.100'",center_freq, samp_rate, htra_source.DecimationFactor.DECIM_256, reference_level,"Complex16bit")
