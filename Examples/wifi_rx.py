...
# Title: WLAN Demod
# Generated: Fri Nov 14 01:10:00 2025
##################################################
...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "WLAN Demod")
        ...
        self.htra_htra_source_0 = htra.htra_source("USB",0,"'192.168.1.100'",freq-lo_offset, 125000000, 4, -50,"Complex16bit")
    ...
    def set_lo_offset(self, lo_offset):
        ...
        self._lo_offset_callback(self.lo_offset)
        self.htra_htra_source_0.set_center_freq(self.freq-self.lo_offset)
