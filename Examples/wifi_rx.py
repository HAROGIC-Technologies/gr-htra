...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "WLAN Demod", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("WLAN Demod")
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-1, 3)
        ...
        self.htra_source_0 = htra_source.htra_source("USB",0,"'192.168.1.100'",freq - lo_offset, 125000000, htra_source.DecimationFactor.DECIM_4, -50)
    ...
    def set_lo_offset(self, lo_offset):
        ...
        self._lo_offset_callback(self.lo_offset)
        self.htra_source_0.set_center_freq(self.freq - self.lo_offset)
